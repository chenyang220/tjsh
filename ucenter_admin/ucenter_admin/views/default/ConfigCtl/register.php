					...
					<ul class="mod-form-rows" id="establish-form">
						...
						<li class="row-item">
							...
							<div class="ctn-wrap">
								...
								<p class="notic">此处设置的密码的最小长度，密码的最大长度默认是20。请填写小于16的正整数</p>
							</div>
						</li>
						<li class="row-item">
							<div class="label-wrap" style="width: 100px;">
								<label for="join_salon">加入沙龙:</label>
							</div>
							<div class="ctn-wrap">
								<input id="join_salon" name="register[join_salon]" value="<?=($data['join_salon']['config_value'])?>" class="ui-input w100" type="text" />
								<p class="notic">请输入沙龙编号 预设:ES88888</p>
							</div>
						</li>
						<li class="row-item">
							<div class="label-wrap" style="width: 100px;">
                        ...
                        <li class="row-item">
							<div class="label-wrap" style="width: 100px;">
								<label for="reg_pwdlength">开放新会员注册:</label>
							</div>
							<div class="ctn-wrap">
                                <input id="register_open" name="register[register]"  value="1" type="radio" <?=($data['register']['config_value']=='1'? 'checked' : '')?>><label title="开放"  for="register_open" >开放</label>
                                <label  id="reg_checkcode_notice"></label>
                                <br/>
                               <input id="register_ban" name="register[register]"  value="2" type="radio" <?=($data['register']['config_value']=='2' ? 'checked' : '')?>><label title="不开放"  for="register_ban">不开放</label>
                               	<p class="notic">开启状态下，会员注册有老会员激活功能和新会员注册功能，可以选择新会员的2种模式；关闭状态，只有老会员激活功能</p>
                        ...
                        <li class="row-item">
							<div class="label-wrap" style="width: 100px;">
								<label for="reg_pwdlength">新会员注册购物:</label>
							</div>
							<div class="ctn-wrap">
                                <input id="register_open" name="register[new_open]"  value="1" type="radio" <?=($data['new_open']['config_value']=='1'? 'checked' : '')?>><label title="新会员注册需要进行购物"  for="register_open" >新会员注册需要进行购物</label>
                                <label  id="reg_checkcode_notice"></label>
                               	<p class="notic">新会员注册需要进行购物，订单需要满足后台设置的积分，才可以完成注册</p>

                                <p/>
                               <input id="register_ban" name="register[new_open]"  value="2" type="radio" <?=($data['new_open']['config_value']=='2' ? 'checked' : '')?>><label title="新会员注册不需要进行购物"  for="register_ban">新会员注册不需要进行购物</label>
                               	<p class="notic">新会员注册不需要进行购物</p>
