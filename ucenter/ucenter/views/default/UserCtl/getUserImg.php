...
?>
      ...
      <!--                         <div class="loading" aria-label="Loading" role="img" tabindex="-1"></div>
            ...
            <!--</form>-->
<!-- new -->
<div  class="amendIconBox">
        <div class="amendIconL">
          <button class="upImg" id="crop-avatar-b">选择要上传的头像</button>
          <p>仅支持JPG、GIF、PNG、BMP格式，文件小于4M</p>
          <div class="amendIconSon" style="display: inline-block">
            <div class="user-avatar" >
                          <div class="container" id="crop-avatar" style="width: 89%;display: block;margin-left: 0;">
                              <!-- Current avatar -->
                              <div class="avatar-view" title="修改头像">
                                  <img id='avatarEdit' src="<?php if (!empty($this->user['info']['user_avatar'])) {
                                  echo image_thumb($this->user['info']['user_avatar'], 120, 120);
...
<!--
          ...
          <button class="SaveChanges" id="submit">保存修改</button>
     
        </div>
</div>

        <div class="amendIconR">
          <p class="adInR_h">效果浏览</p>
          <p>您上传的图片会自动生成2种尺寸的头像</p>
    
        <div class="showIcon_a">
        ...
        <p class="showIcon_p">120像素*120像素</p>
        <div class="showIcon_b">
          <img src="<?php if (!empty($this->user['info']['user_avatar'])) {
                                  echo image_thumb($this->user['info']['user_avatar'], 120, 120);
                              } else {
                                  echo image_thumb($this->web['user_avatar'], 120, 120);
         ...
         <p class="showIcon_p">50像素*50像素</p>
        </div>
...
//    })
      ...
      //       function callback ( respone , api ) {
      //           $('#avatarEdit').attr('src', respone.url);
