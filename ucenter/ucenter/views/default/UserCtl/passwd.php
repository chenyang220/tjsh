...
?>
    ...
    <script src="<?= $this->view->js ?>/md5.js"></script>
    
   
    <div class="form-style-layout formStyleLayout">
        <?php if ($data['user_email_verify'] == 1 || $data['user_mobile_verify'] == 1) { ?>
            <div class="form-style">
                ...
                <dl class="AppMemberHd">
                    <dt class="arrowsR"><a style="margin: auto;" href="javascript:history.go(-1)"><i style="margin-top: 0.6rem;"></i></a></dt>
                    <dd style="width: 100%!important;margin-top: 0.4rem!important;"><p>修改登录密码</p></dd>

                </dl>
                <form id="form" name="form" action="" method="post" class="alterFm appAlterFm">
                  ...
                  <div class="appPasswd">
                    <dl >
                        <dt><em>*</em>旧密码：</dt>
                        <dd>
                            <input type="hidden" class="text" name="oldpass" id="oldpass" placeholder="旧密码" value="<?= $data['password'] ?>">
                            <input type="password" class="text" maxlength="16" name="oldpassword" id="oldpassword" placeholder="请填写旧密码">
                      ...
                      <dl>
                        <dt><em>*</em>新密码：</dt>
                        <dd>
                            <input type="password" class="text" maxlength="16" name="password" id="password" placeholder="6-16位字母数字区分大小写">
                            <span class="btn-eye-icon"></span><!-- 可视加active -->
                        </dd>
                      </dl>
                    <dl>
                        <dt><em>*</em>确认密码：</dt>
                        <dd>
                            <input type="password" class="text" maxlength="16" name="repeat_password" id="repeat_passw密码">
                            <span class="btn-eye-icon"></span> <!-- 可视加active -->
                        </dd>
                    </dl>
                    <dl class="foot appFoot">
                        <dt>&nbsp;</dt>
                        <dd><input type="submit" value="提交" class="submit submitBn"></dd>
                    </dl>
                  </div>
...
//        var pars = 'shuiji=' + sj +'&type='+type +'&val='+val + '&yzm=' + img_yzm; 
                ...
                $(".submit").click(function () {
                    ...
                    if (!oldpassword) {
                        Public.tips.error("<?=_('请输入旧密码')?>");
                        return false;
                    }
                    if (hex_md5(oldpassword) != oldpass) {
                        Public.tips.error("<?=_('您输入的旧密码不正确')?>");
                        return false;
                    }
                ...
                new showPassword('#oldpassword', $('#oldpassword').parent().find('span.btn-eye-icon'), 'active');
