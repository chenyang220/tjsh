...
<body>
    <form name="formimg" action="./index.php?ctl=Login&met=regidapi&typ=json"  method="post" enctype ="multipart/form-data">
        <input type="file" name="images">
        <input type="submit" value="身份证提交">
    </form>
    <br>
    <form name="formimg" action="./index.php?ctl=Login&met=bankcardapi&typ=json"  method="post" enctype ="multipart/form-data">
        <input type="file" name="images1">
        <input type="submit" value="银行卡提交">
    </form>
<!--注册/登录-->
                ...
                <div class="mobile">
                    <div id="Mobile" style="display: <?= $mobile_display ?>">
                        ...
                        <div class="form-item form-item-phonecode">
                            ...
                            <button style="height: 30px;font-size: 11px;display: inherit;margin: auto;background-color: #007673;" id="getPhoneCode" class="btn-phonecode" type="button" onclick="get_randcode()">获取验证码</button>
                            <i class="i-status"></i>
                        </div>
                    </div>
                </div>
...
//			var item = form_account.parent();
    ...
    function registclick() {
        ...
        if(getCookie('UU') && getCookie('UU') != 0){
            var u_p_id = 'u'+getCookie('UU')+'s';
        }else{
            var u_p_id = '';
        }
        ...
        register_obj = $.extend(register_obj, {"u_p_id":u_p_id,"user_account": user_account, "user_password": user_password, "user_code": user_code, "mobile": mobile, "t": token, 'email': email, 'reg_checkcode': reg_checkcode});
