 ...
 */
class User_UmstjTcardbinIModel extends User_UmstjTcardbin
{
	...
	public function getInfoByBin($Bin)
	{
		$data = array();

		$this->sql->setWhere('BIN', $Bin);
	...
	public function getBinIdByBin($Bin=null)
	{
		$data = array();

		$this->sql->setWhere('BIN', $Bin, 'IN');
	...
	public function userlogin($uid=null)
	{
		...
		if($user_info_row)
		{
			...
			$data = array();
			$data['BIN_ID'] = $user_info_row['BIN_ID'];
     ...
     * 修改用户名
     */
	public function alterUsername($BIN_ID, $user_name){
        $this->editInfo($BIN_ID, $user_name);
    }
