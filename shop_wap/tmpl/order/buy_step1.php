...
<head>
    ...
    <style>
        ...
        /*移除不要发票 0012*/
        .nctouch-inp-con .input-box.btn-style label.checked, .nctouch-inp-con .input-box.btn-style em.label.checked{
            color: #007572 !important;
            border: solid 0.05rem #007572!important;
            border-radius: 0.2rem !important;
            padding: 0.1rem 0.5rem !important;
        }
        .nctouch-inp-con .input-box.btn-style label, .nctouch-inp-con .input-box.btn-style em.label{
...
<div class="nctouch-main-layout mb20" id="js-module-order">
        ...
        <div class="nctouch-cart-add-default borb1">
        	<div class='address1 packets-type'>
	            ...
	            <dl>
                    ...
                    <dd><span id="user_address_code" class="z-dhwz wt12"></span></dd>
	            </dl>
   ...
   <div class="nctouch-cart-block bort1 ratePrice pt-10 pb-10" id="support">
    ...
    <div class="nctouch-cart-block bort1 borb1">
        <div class="mrl54 pdt2">
            <a href="javascript:void(0);" class="posr" id="">
                <h3>PV值：</h3>
                <div class="current-con mr53">
                    <p id="PV" style="color: #017472"></p>
                </div>
        </div>
    </div>
    ...
    <!--发票运费信息Begin-->
    <div style="display: none;" class="nctouch-cart-block bort1 borb1 order_invoice_fee1">
        <div class="mrl54 pdt2">
            <a href="javascript:void(0);" class="posr" id="invoice-valve">
            <h3>发票运费：</h3>
            <div class="current-con mr53">
                <p id="order_invoice_fee"></p>
            </div>
        </div>
   </div>
    <!--发票运费信息End-->
                    ...
                    <form id="add_address_form">
                        <ul class="form-box">
                            ...
                            <li class="form-item">
                                <h4>邮政编码</h4>
                                <div class="input-box">
                                    <input type="text" class="inp" name="address_code" id="address_code" autocomplete="off" oninput="writeClear($(this));"/>
                                    <span class="input-del"></span> </div>
                            </li>
...
<!--                        <li><a href="javascript:void(0);" class="sel fz-24 col2" id="invoice-noneed">不开发票</a></li>-->
                        <li><a href="javascript:void(0);" class="fz-24 col2 sel" id="invoice-need">商品明细</a></li>
                    </div>
    ...
    <div class="nctouch-cart-container">
        ...
        <div class="nctouch-cart-subtotal bort1 borb1 mb-20 bgf mt-20">
            ...
            <dl class="borb1 pad30 ">
                <dt>物流配送</dt>
                <dd><em id="storeFreight<%=k%>" class="fz-28 price-color" style="color:#017472">￥<%= store_cart_list[k].freight %></em></dd>
            </dl>
            <!-- 新增店铺代金券 -->
...
<script type="text/html" id="list-address-add-list-script">
    ...
    <li <% if ( (!isEmpty(address_id) && address_list[i].user_address_id == address_id) || (isEmpty(address_id) && address_list[i].user_address_default == 1) ) { %>class="selected"<% } %> data-param="{user_address_id:'<%=address_list[i].user_address_id%>',user_address_contact:'<%=address_list[i].user_address_contact%>',user_address_phone:'<%=address_list[i].user_address_phone%>',user_address_code:'<%=address_list[i].user_address_code%>',user_address_area:'<%=address_list[i].user_address_area%>',user_address_area:'<%=address_list[i].user_address_area%>',user_address_area_id:'<%=address_list[i].user_address_area_id%>',user_address_city_id:'<%=address_list[i].user_address_city_id%>',user_address_address:'<%=address_list[i].user_address_address%>'}"> <i></i>
    <dl class='col2'>
        ...
        <dd><span id="" class="more-overflow wp100"><%=address_list[i].user_address_code %></dd>
    </dl>
    </li>
    <% }} %>
</script>
...
<!--    <div id="electron" style="display: none;">-->
    <div id="electron" style="display: block;">
        <div class="pl-20 pr-20 bgf mb-20 borb1">
            ...
            <label class="checked personal_lable" onclick="CompanyTaxNumShow(0,'electron');" ><i></i>
                <input  type="radio" name="inv_ele_title_type" checked="checked" value="personal"/>
                <span >个人</span>
                <input   type="hidden" name="inv_ele_title"  value="<%=electron[0].name%>" />
            </label>
            ...
            <ul class="mb-20">
                ...
                <li class="form-item ml-0">
                        <select id="inc_content" name="inv_ele_content" class="select hide">
                            <option value="明细">明细</option>
                        <option value="办公用品">办公用品</option>
                            <option value="电脑配件">电脑配件</option>
                            <option value="耗材">耗材</option>
...
<!--                         <option value="办公用品">办公用品</option>
            ...
            <input  type="text" id="inordert" value ="<%=addtax[0].inordert%>">
        </ul>
    </div>
...
<script type="text/javascript" src="../../js/tmpl/invoice.js?ver=1.11"></script>
