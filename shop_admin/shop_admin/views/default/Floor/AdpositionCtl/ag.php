...
<script type="text/javascript">
        ...
        setting_logo_upload = new UploadImage({
            thumbnailWidth:<?php if($data['layout_id']==4){echo 210;}else{echo substr($data["width"],0,strlen($data["width"])-2); }?>,
            thumbnailHeight: <?php if($data['layout_id']==4){echo 210;}else{echo substr($data["height"],0,strlen($data["height"])-2);}?>,
