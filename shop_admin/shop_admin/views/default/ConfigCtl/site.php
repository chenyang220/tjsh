...
<div class="wrapper page">
    ...
    <form method="post" enctype="multipart/form-data" id="shop-setting-form" name="form1">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="common_stock_adjust_unit">库存调整偏差/件</label>
                </dt>
                <dd class="opt">
                    <input id="common_stock_adjust_unit" name="site[common_stock_adjust_unit]" value="<?=($data['common_stock_adjust_unit']['config_value'])?>" class="ui-input w346" type="text" onkeyup="this.value=this.value.replace(/[^\d]/g,'') " onafterpaste="this.value=this.value.replace(/[^\d]/g,'')"/>件

                    <p class="notic">库存调整偏差/件(请输入数字)</p>
                </dd>
            </dl>

            <dl class="row">
                <dt class="tit">
                    <label for="common_stock_adjust_percent">库存调整偏差/百分比</label>
                </dt>
                <dd class="opt">
                    <input id="common_stock_adjust_percent" name="site[common_stock_adjust_percent]" value="<?=($data['common_stock_adjust_percent']['config_value'])?>" class="ui-input w346" type="text" onkeyup="this.value=this.value.replace(/[^\d].[^\d]/g,'') " onafterpaste="this.value=this.value.replace(/[^\d].[^\d]/g,'')"/>%

                    <p class="notic">库存调整偏差/百分比(请输入数字)</p>
                </dd>
            </dl>
