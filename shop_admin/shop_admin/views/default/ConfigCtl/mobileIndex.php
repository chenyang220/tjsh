...
<div class="wrapper page">
    ...
    <div class="mb-special-layout">
        ...
        <div class="module-list">
            ...
            <div class="module_home5"> <span>模型版块布局E</span> <a nctype="btn_add_item" class="add" href="javascript:;" data-module-type="home5"></a> </div>
...
<script>
    ...
    $(document).ready(function(){
            ...
            switch (item_data.mb_tpl_layout_type) {
                ...
                case 'home3' :
                    ...
                    if (item_data.mb_tpl_layout_data && item_data.mb_tpl_layout_data.length>0) {
                        ...
                        layout_html += '<div nctype="item_image" class="item" style="width:306px"> <img nctype="image" src="' + layout_data[0].image + '" alt="" style="max-width: 306px;max-height: 170px;"></div>';
                ...
                case 'home5' :
                    ...
                    html = '<div nctype="special_item" class="special-item home5 '+ (item_data.mb_tpl_layout_enable == 1 ? 'usable' : 'unusable') +'" data-item-id="' + item_data.mb_tpl_layout_id + '">' +
                                '<div class="item_type">模型版块布局E</div>' +
                                '<div id="item_edit_content"><div class="home5"><div class="title"><span></span></div>' +
                                '<div nctype="item_content" class="content">' + layout_html + '</div></div></div>' +
                                '<div class="handle"><a nctype="btn_move_up" href="javascript:;">' +
                                    '<i class="fa fa-arrow-up"></i>上移</a> <a nctype="btn_move_down" href="javascript:;">' +
                                    '<i class="fa fa-arrow-down"></i>下移</a> <a nctype="btn_usable" data-item-id="' + item_data.mb_tpl_layout_id + '" href="javascript:;">' +
        ...
        $('#item_list').on('click', '[nctype="btn_edit_item"]', function() {
            ...
            console.log('url:' +  url_item_edit + '&item_type=' + item_type)
            $.dialog({
                title: title,
