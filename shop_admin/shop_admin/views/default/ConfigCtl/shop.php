        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt" style="width:30%">
                    ...
                    <img id="qr_code_image" name="setting[qr_code_logo]" alt="选择图片" src="<?=($data['qr_code_logo']['config_value'])?>" width="112px" height="112px" />

                    <div class="image-line upload-image"  id="qr_code_upload">上传图片<i class="iconfont icon-tupianshangchuan"></i></div>

                    <input id="qr_code_logo" name="setting[qr_code_logo]" value="<?=($data['qr_code_logo']['config_value'])?>" class="ui-input w400" type="hidden"/>
                    <p class="notic">首页底部二维码，最佳显示尺寸为112*112像素</p>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
...
<script>
    ...
    $(function(){
        ...
        function uploadImage() {
            ...
            var qr_code_upload = new UploadImage({
                thumbnailWidth: 112,
                thumbnailHeight: 112,
                imageContainer: '#qr_code_image',
                uploadButton: '#qr_code_upload',
                inputHidden: '#qr_code_logo'
            });
        }
        ...
        function cropperImage() {
            ...
            $('#setting_logo_upload, #seller_logo_upload, #buyer_logo_upload,#qr_code_upload').on('click', function () {
                ...
                }else if(this.id == 'qr_code_upload'){
                    $imagePreview = $('#qr_code_image');
                    $imageInput = $('#qr_code_logo');
                    imageWidth = 112, imageHeight = 112;
                }
                else {
