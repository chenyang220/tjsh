        ...
        <div class="content">
            ...
            <div class="home2_1">
                <div nctype="item_image" class="item"> <img nctype="image" name="item_data[square_image]" src="<?= $this->view->img_com ?>/image.png" alt="">
                    ...
                    <a nctype="btn_edit_item_image" data-name="square" data-desc="430*370" href="javascript:;"><i class="fa fa-pencil-square-o"></i>编辑</a>
                </div>
            </div>
            <div class="home2_2">
                <div class="home2_2_1">
                    <div nctype="item_image" class="item"> <img nctype="image" name="item_data[rectangle1_image]" src="<?= $this->view->img_com ?>/image.png" alt="">
                        ...
                        <a nctype="btn_edit_item_image" data-name="rectangle1" data-desc="270*180" href="javascript:;"><i class="fa fa-pencil-square-o"></i>编辑</a>
                    </div>
                </div>
                <div class="home2_2_2">
                    <div nctype="item_image" class="item"> <img nctype="image" name="item_data[rectangle2_image]" src="<?= $this->view->img_com ?>/image.png" alt="">
                        ...
                        <a nctype="btn_edit_item_image" data-name="rectangle2" data-desc="270*180" href="javascript:;"><i class="fa fa-pencil-square-o"></i>编辑</a>
                    </div>
                </div>
            </div>
        </div>
