                ...
                <div class="ncap-form-default">
                    <dl class="row">
                        ...
                        <dd class="opt">
                            ...
                            <p id="dialog_image_desc" class="notic">推荐图片尺寸750*363</p>
                        </dd>
                    </dl>
                    <dl class="row">
                        <dt class="tit">商品名称：</dt>
                        <dd class="opt">
                            <input id="dialog_item_image_shop_name" type="text" class="txt w200 marginright marginbot vatop">
                        </dd>
                    </dl>
                    <dl class="row">
                        ...
                        <dd class="opt">
                            <select id="dialog_item_image_type" name="" class="vatop">
                                ...
                                <option value="spec_url">特殊链接</option>
                            </select>
    ...
    $(function() {
        ...
        function change_image_type_desc(type) {
            ...
            if (type != '') {
                ...
                desc_array['spec_url'] = '链接会跳转到指定链接，输入框填写部分的URL。';
        ...
        api.button({
            id: "confirm", name: '确定', focus: !0, callback: function ()
            {
                ...
                img_data.image_shop_name = $('#dialog_item_image_shop_name').val();
