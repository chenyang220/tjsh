...
function initGrid()
{
    ...
    var t = ["操作", "导航名称", "导航链接", "导航图片"], e = [{
        ...
        {name: "nav_name", index: "nav_name",align:"center",width:150},
        {name: "nav_url", index: "nav_url", align: "center",width: 150},
        {name: "nav_image", index: "nav_image",  align: "center",width: 100, formatter: imageFmatter}
    ];
    $("#grid").jqGrid({
        url: SITE_URL + '?ctl=Mb_NavImage&met=navImageList&typ=json',
        datatype: "json",
...
var handle = {
    operate: function (t, e)
    {
        ...
        $.dialog({
            title: i,
            content: "url:"+ SITE_URL + "?ctl=Mb_NavImage&met=manage&typ=e",
            data: a,
            width: 635,
            height: 520,
            max: !1,
    ...
    }, callback: function (t, e, i)
    {
        ...
        if ("edit" == e)
        {
            $("#grid").jqGrid("setRowData", t.nav_id, t);
            i && i.api.close();
           
        }
        else
        {
            $("#grid").jqGrid("addRowData", t.nav_id, t, "last");
            i && i.api.close();
        }
    ...
    }, del: function (t)
    {
        ...
        {
            Public.ajaxPost(SITE_URL + "?ctl=Mb_NavImage&met=removeNavImage&typ=json", {nav_id: t}, function (e)
            {
                if (e && 200 == e.status)
                {
...
function operFmatterCIMG(val, opt, row) {
    var html_con = '<div class="operating" data-id="' + row.nav_id + '"><span class="ui-icon ui-icon-pencil" title="修改"></span><span class="ui-icon ui-icon-trash" title="删除"></span></div>';
    return html_con;
};
